 const event_json = `{
  "intro_qsdokx": {
    ...
    "dialogue": [
        ...
        "Je vous laisse une <b>carte des environs.</b> <br>Elle vous indiquera les directions à suivre, vous permettra de vous géolocaliser et de rechercher des coordonnées GPS.",
  ...
  "8228": {
    ...
    "dialogue": [
        ...
        "D’ailleurs seriez-vous capable de relier ces colonnes avec leur période historique correspondante ? <br>Je suis sûre que vous y trouverez <b>une information qui vous aidera</b> pour la suite de votre aventure !",
        "",
  ...
  "2753": {
    ...
    "dialogue": [
        ...
        "<i>Il se retourne et s’éloigne. Vous apercevez un morceau de papier tomber de sa poche. <br>Vous le récupérez et découvrez un étrange message : <br>45.845790,4.575595</i>"
      ],
    "help": [
